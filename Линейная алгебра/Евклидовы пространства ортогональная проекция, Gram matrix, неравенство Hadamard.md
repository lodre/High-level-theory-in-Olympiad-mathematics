...
Константа $d$ — Grinberg–Sevastyanov, точная константа Стейница для евклидовой нормы открыта; известно $\le d$ универсально и $\ge \sqrt{(d+3)/4}$ (нижний пример Bárány–Grinberg). Простой жадный шаг даёт лишь $\le \sqrt n$.
